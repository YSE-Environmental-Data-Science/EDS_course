...
Once you've got the URL, navigate to your workspace/working directory in RStudio for this course. Follow the code below to download and unzip "EDS_Course_Materials.zip".
