...
Before starting the workshops, install R, RStudio, and the R packages used across the course. Some packages are used in only one workshop, but installing them now prevents small setup problems from interrupting class time.
...
These packages are optional or may require additional setup:

```{r}
#| eval: false
# ERA5 downloads require a CDS account and API key.
install.packages("ecmwfr")

# Helpful for spatial examples, but not required by the rendered workshops.
install.packages("rnaturalearth")
```

::: {.callout-note}
## Optional data products for final projects
The course data package contains the files needed to run the core workshops. Final projects may require additional products, including ERA5 climate downloads and WAD2M inundation fractions. The Data Integration and Spatial Model Visualization workshops show where those products should be saved under `data/products/`.
:::

## Setup your directory for the course

(1) Create a folder for this course called "EDS730"
(2) Create a new Rstudio project called EDS730 and save it in your folder EDS730
(3) Download the course datafile from EDI: [https://doi.org/10.6073/pasta/5100e60582808c66095e767be806109f](https://doi.org/10.6073/pasta/5100e60582808c66095e767be806109f)
(4) Unzip and move the file into the EDS730 folder.
(5) Change the name of the folder "EDS_Course_Materials" to "data"
(6) In the data folder create a folder called "products"
(7) In the EDS730 folder create a folder called "scripts"
...
To get the data programmatically through R, first navigate to the data package landing page at: [https://doi.org/10.6073/pasta/5100e60582808c66095e767be806109f](https://doi.org/10.6073/pasta/5100e60582808c66095e767be806109f)
...
*ISSUE - EDI requires authentication for API access as of July 30, 2026: https://edirepository.org/news/news-20260727.00
