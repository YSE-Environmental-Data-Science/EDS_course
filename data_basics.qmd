...
Determine the average monthly conditions using `group_by()` and `summarise()` :
...
Determine the average conditions using `group_by()` and `summarise()` by both year and month:
